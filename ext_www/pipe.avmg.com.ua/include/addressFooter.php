    ...
    <div class="address-data-other">
        <span class="data-box-title">Загальна інформація</span>
        <div class="other-data-inner">
            <i class="fa fa-map-marker" aria-hidden="true"></i>
            <address>УкраЇна, Дніпро,<br>
                вул. Шолом-Алейхема, 5</address>
            <div class="phone">
                <i class="fa fa-phone" aria-hidden="true"></i>
            ...
            <div class="mail">
                ...
                <div class="box-in-move">
                    ...
                    <!--            <a href="mailto: v.khorunjiy@avmg.com.ua">v.khorunjiy@avmg.com.ua</a><br>-->
                    <a href="mailto: s.kireev@avmg.com.ua">s.kireev@avmg.com.ua</a>
                </div>
            </div>
        </div>
    </div>