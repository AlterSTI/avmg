...
try{
    ...
    $ClientInfo->setBrowserChecking('firefox', 50.0);//да
    $ClientInfo->setBrowserChecking('chrome', 50.0);//да
    $ClientInfo->setBrowserChecking('opera', 40.0);//да
    $ClientInfo->setBrowserChecking('safari', 6.0);//да
    $ClientInfo->setBrowserChecking('yandex', 16.0);//да
    $ClientInfo->setBrowserChecking('internet explorer', 12.0);//нет
    $ClientInfo->setBrowserChecking('edge', 14.0);// Сильно свежий нет возможности проверить!
    $ClientInfo->setBrowserChecking('android', 5.0);//да
