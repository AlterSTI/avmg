...
<div id="map_canvas_big" class="imageClass imageClassMap"></div>
    ...
    <div class="conta text-center" style="background: url(<?=$arResult['IMAGES_INFO'][0]['url']?>) no-repeat  center; background-size: cover;">
        <div class="logoTextWrap">
            ...
            <div class="secondWrapBG">
				<div class="textWrap text-center bud-header-txt"><img src="/upload/av_site/landings/av-shpola/logo_Shpola.png" alt="" />
...
<div class="col-sm-12 col-xs-12 map-address-txt" id="mapText">
...
<div id="map_canvas2" class=""></div>
	...
	<div class="col-sm-12 col-xs-12 social-img" id="socialImg">
				<?$APPLICATION->IncludeComponent(
				"bitrix:main.include",
				"",
				Array(
