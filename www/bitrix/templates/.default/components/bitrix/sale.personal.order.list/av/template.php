...
else
{
	...
	?>
	<div class="row col-md-12 col-sm-12  row-flex">
		<?
		...
		{
			?>
			<a class="sale-order-history-link av-form-elements-av_site-button" href="<?=$APPLICATION->GetCurPageParam("filter_history=Y", $clearFromLink, false)?>">
		...
		{
			?>
			<a class="sale-order-history-link av-form-elements-av_site-button" href="<?=$APPLICATION->GetCurPageParam("", $clearFromLink, false)?>">
			...
			{
				?>
				<a class="sale-order-history-link av-form-elements-av_site-button" href="<?=$APPLICATION->GetCurPageParam("filter_history=Y&show_canceled=Y", $clearFromLink, false)?>">
			...
			<div class="col-md-12 col-sm-12 sale-order-list-container">
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12 ">
						<span class="sale-order-list-title">
				...
				<div class="row">
					<div class="col-md-12 sale-order-list-inner-container">
						...
						<div class="row sale-order-list-inner-row">
							<div class="sale-order-list-top-border"></div>
							<div class="col-md-6  col-sm-12 sale-order-list-about-container">
							...
							<div class="col-md-3 col-sm-12 sale-order-list-repeat-container text-right">
							...
							<div class="col-md-3 col-sm-12 sale-order-list-cancel-container text-right">
					...
					<div class="col-md-12 col-sm-12 sale-order-list-accomplished-title-container">
						<div class="row">
							<div class="col-md-8 col-sm-12 sale-order-list-accomplished-title-container">
								<span class="sale-order-list-accomplished-title">
									<?= Loc::getMessage('SPOL_TPL_ORDER') ?>
