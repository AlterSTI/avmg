...
(function($)
{
    jQuery.fn.getFormElememtNameCheckboxAvCorp = function()
    {
        return this.find(':ckeckbox').attr('name');
    };
    jQuery.fn.setFormElememtNameCheckboxAvCorp = function(value)
    {
        this.find(':ckeckbox').attr('name', value);
    };
    ...
    jQuery.fn.getFormElememtRequiredCheckboxAvCorp = function()
    {
    ...
    jQuery.fn.getFormElememtAlertCheckboxAvCorp = function()
    {
...
$(function()
    ...
    $(document)
        ...
        {
            var
                $inputBlock = $(this).closest('.av-form-checkbox-corp'),
                $checkbox   = $inputBlock.find(':checkbox');

            $inputBlock.setFormElememtValueCheckboxAvCorp(!$checkbox.is(':checked'));
        });
    });