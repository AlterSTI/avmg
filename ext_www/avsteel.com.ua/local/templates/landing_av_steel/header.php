...
?>
	...
	?>
        ...
        <head>
			...
			<?CJSCore::Init(["av", "bootstrap","js_main"])?>
			...
			$APPLICATION->AddHeadScript('/bitrix/js/av/main.js');
			?>
			<script async src="https://www.googletagmanager.com/gtag/js?id=UA-102409654-1"></script>
			<script>
	        ...
	        <script type="text/javascript" >
		        (function (d, w, c)
			        ...
			        (w[c] = w[c] || []).push(function()
			            ...
			            try
				            {
				            w.yaCounter44830414 = new Ya.Metrika
				                ({
				                id                 : 44830414,
				                clickmap           : true,
				                trackLinks         : true,
			        ...
			        s.async = true; s.src = "https://cdn.jsdelivr.net/npm/yandex-metrica-watch/watch.js";
