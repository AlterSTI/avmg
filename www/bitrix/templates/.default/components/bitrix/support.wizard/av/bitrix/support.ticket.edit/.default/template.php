...
<table class="support-ticket-edit-form data-table">
	...
	<tr>
		...
		<td class=""><input type="text" class="input-field" name="TITLE" value="<?=htmlspecialcharsbx($_REQUEST["TITLE"])?>" size="48" maxlength="255" /></td>
	</tr>
	<?else:?>
	...
	<?if (strlen($arResult["TICKET"]["DATE_CLOSE"]) <= 0):?>
        ...
        <?
        //if( in_array(14, $USER->GetUserGroupArray())){
        ?>
	<tr>
	...
	<tr>
		<td></td>
		<td><textarea name="MESSAGE" id="MESSAGE" wrap="virtual"><?=htmlspecialcharsbx($_REQUEST["MESSAGE"])?></textarea></td>
	</tr>
        <?//}?>
