...
<div class="product-item">
    <a class="link-wrap" href="<?=$item['DETAIL_PAGE_URL']?>" >
                ...
                switch ($blockName)
                {
                    ...
                    <?if($_COOKIE['viewCatalog'] != "line") { ?>
                        <div class="product-item-info-container product-item-price-container" data-entity="price-block">
                            ...
                            <div class="product-item-price-current text-center" id="<?=$itemIds['PRICE']?>">
                                ...
                                if (!empty($price))
                                {
                                    ...
                                    foreach($item["OFFERS"] as $propSku){
                                        if($propSku["MIN_PRICE"]["VALUE_NOVAT"]){
                                    ...
                                    echo "от " . $item["OFFERS"]["$key"]["MIN_PRICE"]["VALUE_NOVAT"] . " грн";
                                    }
							...
							/* ------------------------------------------- */
                            ?>
                            <?if(count($arResult["ITEM"]["OFFERS_VALUES"])):?>
                            <div class="sku-info">
                                <?foreach($arResult["ITEM"]["OFFERS_VALUES"] as $offerInfo):?>
                                <div class="prop-row">
                                    <?=$offerInfo["NAME"]?>:
									<?
									/* ---------------------------- */
                                    ...
                                    <?if($offerInfo["VALUE_TYPE"] == 'NUMBER'):?>
										...
										<?else:?>                      <?=GetMessage("AV_CATALOG_ITEM_SKU_INFO_RANGE",  ["#MIN_VALUE#" => $minValue, "#MAX_VALUE#" => $maxValue])?>
										<?endif?>
                            ...
                            <div class="sku_prop row no-padding">
                                <?/*
                                ...
                                */
                               ?>
                               <div class="col-md-9 no-padding"> <? print_r($item["PREVIEW_TEXT"]);?></div>
                                   <?if($_COOKIE['viewCatalog'] == "line") { ?>
                                    <div class="col-md-3">
