...
$arUserFieldNames = array('PERSONAL_PHOTO', 'FULL_NAME', 'ID','LOGIN','NAME','SECOND_NAME','LAST_NAME','EMAIL','DATE_REGISTER','PERSONAL_PROFESSION','PERSONAL_WWW','PERSONAL_BIRTHDAY','PERSONAL_ICQ','PERSONAL_GENDER','PERSONAL_PHONE','PERSONAL_FAX','PERSONAL_MOBILE','PERSONAL_PAGER','PERSONAL_STREET','PERSONAL_MAILBOX','PERSONAL_CITY','PERSONAL_STATE','PERSONAL_ZIP','PERSONAL_COUNTRY','PERSONAL_NOTES', 'WORK_POSITION', 'WORK_COMPANY', 'WORK_PHONE', 'WORK_FAX', 'ADMIN_NOTES','XML_ID');
...
$arTemplateParameters = array(
	...
	"TABLE_VIEW" => array(
		...
		"TYPE" => "LIST",
		"VALUES" => array('.default' => GetMessage('ISL_PARAM_LIST_VIEW_VALUE_list'), 'group_table' => GetMessage('ISL_PARAM_LIST_VIEW_VALUE_group')),
		"MULTIPLE" => "N",
		"DEFAULT" => 'group',
		'REFRESH' => 'Y',
        "HIDDEN" => "Y"
