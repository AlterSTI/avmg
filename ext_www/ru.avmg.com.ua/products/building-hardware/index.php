...
$APPLICATION->SetTitle("Строительный крепеж");
$APPLICATION->SetPageProperty("title",       "Крепеж ► купить строительный крепеж в Украине: Днепр, Киев, Харьков, Львов, Одесса, опт, розница | Направление АВ металл групп ™ ru.avmg.com.ua");
$APPLICATION->SetPageProperty("description", "Строительный крепеж ассортимент и цены ▻ АВ металл групп ™ ✓Широкий выбор ✓Металлобазы и доставка по всей Украине ☎ (056)790-01-22");
...
$APPLICATION->IncludeComponent
	...
	"bitrix:news", "av",
		...
		"SEF_MODE"          => "Y",
		"SEF_FOLDER"        => "/products/building-hardware/",
