...
/* -------------------------------------------------------------------- */
?>
<div class = "av-bases-list-detail-container" data-here-map-app-id ="<?=$arParams['HERE_MAP_APP_ID']?>" data-here-map-app-code ="<?=$arParams['HERE_MAP_APP_CODE']?>">
                ...
                <?foreach($coast as $arItem){?>
                    <div class="banks-main-wrapper-box" data-item-id-base="<?=$arItem['BASE_ID']?>">
                        <div class="banks-main-inner">
                            <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3 banks-first-contacts">
                                ...
                                <address class="address-box address-banks-side">
                                    ...
                                    <span class="banks-cord" data-cordinate-x = "<?=$arItem['cordinateX']?>"
                                                             ...
                                                             data-marker = "<?=$this->GetFolder().'/images/marker.png'?>"
                                    >
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-9 col-xl-9 bank-map-data">
                                <h2>Карта проезда</h2>
                                <div id = "base_<?=$arItem['BASE_ID']?>" class="google-map-detail"></div>
                            </div>
                            <div class="hidden-sm hidden-md hidden-lg hidden-xl bank-map-data">
