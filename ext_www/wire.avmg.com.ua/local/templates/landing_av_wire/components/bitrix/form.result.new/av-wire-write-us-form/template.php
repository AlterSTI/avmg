...
<div class="text-uppercase text-center title-form-1"><span><?=Loc::getMessage('AV_FORM_MAKE_WRITE')?></span></div>
<?=$arResult["FORM_HEADER"]?><div class="av-form-wrap-2 clearfix">
	...
	<?foreach ($arResult["QUESTIONS"] as $FIELD_SID => $arQuestion):?>
		...
		?>
		<div
			class="write-fom-row <?if($arQuestion["REQUIRED"] == "Y"):?>required<?endif?>"
	...
	/* --------------------------------------------------------------------- */
	?>
<div class="col-md-12 write-form-submit">
