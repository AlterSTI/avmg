...
<a class="create-btn" href="<?=$APPLICATION->GetCurPage()."?show_wizard=Y"?>"><?=GetMessage("SUP_ASK")?></a>
...
<table class="support-ticket-hint" width="100%">

    <tr class="table-headder">

        <td>Индикатор</td> <td class="text-center">Определение</td>
    </tr>
	<tr>
