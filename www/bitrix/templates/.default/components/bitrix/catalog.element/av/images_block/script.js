...
$(function()
	...
	var
		...
		$mainSlider                = $imageBlock.find(".slider"),
	...
	$mainSlider.find(".navigation.prev").setAvSliderNavigationItem("back");
	$mainSlider.find(".navigation.next").setAvSliderNavigationItem("forward");
	$mainSlider.find(".slider-block")   .setAvSliderSlidesBlock();
