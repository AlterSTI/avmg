...
<div class="av-vs-page-block">
	<div class="container">
		<div class="col-lg-7 col-md-7">
			ТОВ "АВ метал груп" - велика і незалежна торгова компанія в Україні.
			Ми почали свою діяльність на ринку металопрокату у червні 2009 року і через кілька років стали масштабним українським постачальником.
			Сьогодні "АВ метал груп" - один з лідерів серед компаній, представлених у цьому бізнес-сегменті.
			Ми надаємо споживачам широкий вибір сортового, фасонного, трубного і плоского металопрокату.
			Співпрацюючи з відомими світовими виробниками, забезпечуємо покупців надійною і якісною продукцією.
			Компанія продовжує розвиватися, відкриваючи нові філії і металобази по всій Україні.
		</div>
	...
	<div class="container">
		...
		<div class="col-lg-10 col-lg-offset-1">
			<p class="av-vs-page-block-subtitle">
				 Широкий асортимент товарів, якісні послуги, точне оперативне і надійне рішення будь-якого питання отримують клієнти компанії "АВ Метал груп". Ми надаємо вигідні умови співпраці й зацікавлені у надійному і довгостроковому партнерстві.
			</p>
		</div>
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-6">
				...
				<div class="av-vs-page-text-sm-block">
					Нас вибрали понад 20000 українських покупців. Серед них найбільші промислові та будівельні компанії.
				</div>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-6">
		...
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-6">
				...
				<div class="av-vs-page-text-sm-block">
					Наш центр логістики та широкий власний автопарк дозволяють доставити товар клієнту в найкоротші терміни.
				</div>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-6">
			...
			<div class="col-lg-3 col-md-3 col-sm-6">
				...
				<div class="av-vs-page-text-sm-block">
					Компанія зацікавлена в навчанні та розвитку персоналу, забезпечуючи при цьому стабільну роботу й кар'єрне зростання.
				</div>
			</div>
		</div>
	</div>
