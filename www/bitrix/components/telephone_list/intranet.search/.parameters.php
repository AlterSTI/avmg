...
$arComponentParameters = array(
	...
	'PARAMETERS' => array(
        ...
        /*'FIELDS_USE_IN_TABLE_FILTER' => array(
            'TYPE' => 'LIST',
            'MULTIPLE' => 'Y',
            'ADDITIONAL_VALUES' => 'N',
            'VALUES' => CSocNetUser::GetFields(true),
            'NAME' => GetMessage('INTR_FIELDS_USE_IN_TABLE_FILTER'),
            'PARENT' => 'ADDITIONAL_SETTINGS',
        ),
        'USER_FIELDS_USE_IN_TABLE_FILTER' => array(
            'TYPE' => 'LIST',
            'MULTIPLE' => 'Y',
            'ADDITIONAL_VALUES' => 'N',
            'VALUES' => $userProp,
            'NAME' => GetMessage('INTR_USER_FIELDS_USE_IN_TABLE_FILTER'),
            'PARENT' => 'ADDITIONAL_SETTINGS',
        ),*/
	),
);
